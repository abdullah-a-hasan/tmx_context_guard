...
# XTM
tmx_context_defs['xtm'] = {"label": "XTM",
                           "prev_text_prop": "x-previous-source-text",
...
# GlobalLink/WordFast
tmx_context_defs['gl'] = {"label": "TransPerfect (GL/Wordfast)",
                          "prev_text_prop": "previousMd5Segment",
...
# Trados
tmx_context_defs['trados'] = {"label": "RWS (Trados)",
                              "prev_text_prop": "x-ContextContent",
